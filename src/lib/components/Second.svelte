<section class="px-10 py-10 lg:pl-24 bg-gray-50 lg:py-28">
	<div class="flex flex-col mx-auto sm:flex-row">
		<div class="w-full sm:w-1/2">
			<h2
				class="max-w-sm text-2xl font-semibold text-gray-900 md:max-w-md lg:max-w-lg xl:max-w-xl 2xl:max-w-2xl"
				data-aos="fade-left"
				data-aos-delay="900"
			>
		...
		<div class="w-full mt-10 sm:w-1/2 sm:mt-0">
			<div data-aos="fade-left" data-aos-delay="1100">
				<iframe
					...
					id="datawrapper-chart-2vgUD"
					src="https://datawrapper.dwcdn.net/2vgUD/1/"
					scrolling="no"
					frameborder="0"
