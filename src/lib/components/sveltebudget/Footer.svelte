...
<footer class="relative py-16 overflow-hidden bg-gray-900 lg:py-36">
	...
	<div class="relative px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
		<div class="grid grid-cols-1 gap-y-12 lg:grid-cols-2 xl:grid-cols-7 gap-x-8 xl:gap-x-16">
			<div class="max-w-md mx-auto text-center xl:col-span-3 lg:max-w-sm lg:mx-0 lg:text-left">
				<a href="/" title="" class="">
					<img
						class="w-auto h-14"
						data-aos="fade-up"
			...
			<div class="overflow-hidden lg:-ml-12 lg:-my-8 bg-base-900 rounded-xl xl:col-span-4">
				<div class="p-8 sm:p-12" data-aos="fade-up" data-aos-delay="500">
					<div class="grid grid-cols-2 gap-y-12 sm:grid-cols-3 gap-x-12 xl:gap-x-16">
						...
						<div>
							<h6 class="text-base font-semibold text-white">Learn more</h6>
						...
						<div>
							<h6 class="text-base font-semibold text-white">Extra links</h6>
					...
					<div class="sm:flex sm:items-center sm:justify-between">
						<p class="text-sm text-white">© Copyright 2023 Prospera. All Rights Reserved</p>
